<template>
	<view class="index">
		...
		<components v-if="tabberPageLoadFlag[1]" :style="{display: currentIndex === 1 ? '' : 'none'}" ref="components">
		</components>
		<templatePage v-if="tabberPageLoadFlag[2]" :style="{display: currentIndex === 2 ? '' : 'none'}" ref="template">
		</templatePage>
...
<script>
	...
	import TemplatePage from '../template/nvueSwiper.nvue'
